  ...
  "demo-logcraft": [
    {
      ...
      bugCount: 0,
      bugLogs: "",
      promptReview: "Muito bom! Testei prompts em inglês e português. A geração de logos minimalistas com estilos geométricos funcionou perfeitamente. Os detalhes das curvas SVG ficaram super limpos.",
      detailedFeedback: "Interface de edição é ótima! A ferramenta de exportação em SVG gera um arquivo limpo e bem formatado. Sugiro adicionar uma opção de 'grade de alinhamento' no canvas para facilitar o posicionamento do texto em relação ao ícone.",
      status: "approved",
    ...
    },
    {
      ...
      promptReview: "Gera ícones de altíssima qualidade, mas sinto falta de suporte a prompts em espanhol.",
      detailedFeedback: "Gostei muito da velocidade de geração! O tempo de resposta foi de apenas 4 segundos. O bug da ferramenta de corte no Firefox é chato mas fácil de mitigar com overflow hidden. Excelente projeto!",
      status: "approved",
  ...
  "demo-devpulse": [
    {
      ...
      bugLogs: "",
      promptReview: "",
      detailedFeedback: "Conectei ao meu repositório e os gráficos de commits por hora foram super úteis para notar os picos de trabalho da equipe. A performance da sincronização via webhook é excelente, responde em milissegundos.",
      status: "approved",
  ...
  "demo-saasboard": [
    {
      ...
      detailedFeedback: "Um micro-saas muito necessário! O layout escuro com azul-violeta é lindíssimo. A integração com a Stripe funcionou sem problemas no modo de teste. O bug da conversão de moeda histórica pode ser resolvido com uma API de taxas de câmbio históricas.",
      status: "approved",
